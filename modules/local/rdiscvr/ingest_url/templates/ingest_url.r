#!/usr/bin/env Rscript
# Nextflow template: ingest_url.r
# INGEST_URL — download a data file from a public URL and load it as a Seurat object.
#
# Nextflow substitutions:
#   ${meta.id}          – sample identifier
#   ${meta.species}     – sample species label
#   ${meta.url ?: ''}   – download URL (empty string if absent; validated below)
