...
if [[ -z "${WORKFLOW}" ]]; then
    ...
    echo "Valid options: integration, ingest_export, ingest_tabulate, nmf_vae, gex_mil, tcr_mil, tcr_epitope"
    echo ""
...
VALID_WORKFLOWS=("integration" "ingest_export" "ingest_tabulate" "nmf_vae" "gex_mil" "tcr_mil" "tcr_epitope")
