...
| Parameter | Default | Description |
|---|---|---|
| `--scmodal_container` | `ghcr.io/gwmcelfresh/scmodal:sha-37c41f9` | Container image for `GENE_HARMONIZE` and `SCMODAL_INTEGRATE`. Must include `scmodal`, `torch`, `scanpy`, and `anndata`. |
