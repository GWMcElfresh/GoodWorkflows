...
| [`batch_effect_assessments`](workflows/batch-effect-assessments.md) | Ingest → LISI / CiLISI / ASW / optional kBET on Seurat embeddings | **HPC CPU** (GoodWorkflows base + uvr) |
