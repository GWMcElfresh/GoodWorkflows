# Requirements grill (Q&A ledger)

Persistent question-and-answer records for GoodWorkflows evolve cycles. Agents use the **`grill-me`** skill (`.cursor/skills/grill-me/SKILL.md`) to create, update, and accept these files before technical planning.
